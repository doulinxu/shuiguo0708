"object" == typeof navigator && function(e, t) {
    ...
    function A(e, t, n) {
        ...
        return m.object(t) && T(i, t),
        m.string(n) && (i.innerText = n),
        i
    }
    function E(e, t, n, i) {
    ...
    function S(e, t) {
        return m.element(t) && m.element(t.parentNode) && m.element(e) ? (t.parentNode.replaceChild(e, t),
        e) : null
    }
    function M(e, t) {
        if (!m.string(e) || m.empty(e))
            return {};
        var n = {}
          , i = t;
    ...
    var q, R, B, D = (q = document.createElement("span"),
    R = {
    ...
    var H, F = {
        ...
        cancelRequests: function() {
            this.isHTML5 && (P(W.getSources.call(this)),
    ...
    function J() {
        ...
        return m.object(s) ? (Object.keys(s).forEach(function(t) {
            m.object(s[t]) ? (Object.keys(e).includes(t) || Object.assign(e, i({}, t, {})),
    ...
    var ce = {
        ...
        findElements: function() {
            try {
                return this.elements.controls = j.call(this, this.config.selectors.controls.wrapper),
                ...
                this.elements.progress = j.call(this, this.config.selectors.progress),
                ...
                m.element(this.elements.progress) && (this.elements.display.seekTooltip = this.elements.progress.querySelector(".".concat(this.config.classNames.tooltip))),
                !0
            } catch (e) {
        ...
        createButton: function(e, t) {
            ...
            case "play-large":
                ...
                break;
            default:
                m.empty(a.label) && (a.label = i),
                m.empty(a.icon) && (a.icon = e)
            }
            var s = A(a.element);
            ...
            T(s, n),
            "play" === i ? (m.array(this.elements.buttons[i]) || (this.elements.buttons[i] = []),
        ...
        updateVolume: function() {
            this.supported.ui && (m.element(this.elements.inputs.volume) && ce.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
            m.element(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
        },
        setRange: function(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
            m.element(e) && (e.value = t,
            ...
            if (this.supported.ui && m.event(e)) {
                ...
                if (e)
                    ...
                    case "seeked":
                        ...
                        "timeupdate" === e.type && ce.setRange.call(this, this.elements.inputs.seek, a);
                        break;
                    case "playing":
                    case "progress":
                        !function(e, n) {
            ...
            if (this.config.tooltips.seek && m.element(this.elements.inputs.seek) && m.element(this.elements.display.seekTooltip) && 0 !== this.duration) {
                ...
                if (this.touch)
                    ...
                    if (m.event(e))
                        ...
                        if (!x(this.elements.display.seekTooltip, a))
                            return;
                    ...
                    m.event(e) && ["mouseenter", "mouseleave"].includes(e.type) && s("mouseenter" === e.type)
                }
            }
        },
        ...
        durationUpdate: function() {
            if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
                if (this.duration >= Math.pow(2, 32))
                    return N(this.elements.display.currentTime, !0),
        ...
        updateSetting: function(e, t, n) {
            ...
            if (m.element(s) || (s = i && i.querySelector('[role="menu"]')),
            m.element(s)) {
        ...
        setQualityMenu: function(e) {
            ...
            if (m.element(this.elements.settings.panels.quality)) {
                ...
                if (ce.toggleMenuButton.call(this, "quality", i),
                C(n),
        ...
        setCaptionsMenu: function() {
            ...
            if (m.element(this.elements.settings.panels.captions)) {
                var t = this.elements.settings.panels.captions.querySelector('[role="menu"]')
                  ...
                  , i = Boolean(n.length);
                if (ce.toggleMenuButton.call(this, "captions", i),
                C(t),
                ce.checkMenu.call(this),
                i) {
        ...
        setSpeedMenu: function(e) {
            ...
            if (m.element(this.elements.settings.panels.speed)) {
                ...
                m.array(e) ? this.options.speed = e : (this.isHTML5 || this.isVimeo) && (this.options.speed = [.5, .75, 1, 1.25, 1.5, 1.75, 2]),
        ...
        toggleMenu: function(e) {
            ...
            if (m.element(t) && m.element(n)) {
                ...
                if (m.boolean(e))
                    a = e;
                else if (m.keyboardEvent(e) && 27 === e.which)
                    a = !1;
                else if (m.event(e)) {
                ...
                a && m.keyboardEvent(e) ? ce.focusFirstMenuItem.call(this, null, !0) : a || i || O.call(this, n, m.keyboardEvent(e))
            }
        },
        ...
        showMenuPanel: function() {
            ...
            if (m.element(i)) {
                ...
                N(s, !0),
                N(i, !1),
                ce.focusFirstMenuItem.call(this, i, n)
            }
        },
        ...
        create: function(e) {
            ...
            if (this.config.controls.includes("restart") && n.appendChild(ce.createButton.call(this, "restart")),
            this.config.controls.includes("rewind") && n.appendChild(ce.createButton.call(this, "rewind")),
            this.config.controls.includes("play") && n.appendChild(ce.createButton.call(this, "play")),
            this.config.controls.includes("fast-forward") && n.appendChild(ce.createButton.call(this, "fast-forward")),
            ...
            if (this.config.controls.includes("current-time") && n.appendChild(ce.createTime.call(this, "currentTime")),
            this.config.controls.includes("duration") && n.appendChild(ce.createTime.call(this, "duration")),
            this.config.controls.includes("mute") || this.config.controls.includes("volume")) {
                var s = A("div", {
                    class: "plyr__volume"
                });
                if (this.config.controls.includes("mute") && s.appendChild(ce.createButton.call(this, "mute")),
            ...
            if (this.config.controls.includes("captions") && n.appendChild(ce.createButton.call(this, "captions")),
            this.config.controls.includes("settings") && !m.empty(this.config.settings)) {
                var r = A("div", {
                    class: "plyr__menu",
                    hidden: ""
                });
            ...
            if (this.config.controls.includes("pip") && z.pip && n.appendChild(ce.createButton.call(this, "pip")),
            this.config.controls.includes("airplay") && z.airplay && n.appendChild(ce.createButton.call(this, "airplay")),
            ...
            return this.config.controls.includes("fullscreen") && n.appendChild(ce.createButton.call(this, "fullscreen")),
        ...
        inject: function() {
            ...
            var i = {
              ...
              , s = !0;
            m.function(this.config.controls) && (this.config.controls = this.config.controls.call(this.props)),
            this.config.controls || (this.config.controls = []),
            m.element(this.config.controls) || m.string(this.config.controls) ? n = this.config.controls : (n = ce.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
            ...
            if (s && (m.string(this.config.controls) ? n = r(n) : m.element(n) && (n.innerHTML = r(n.innerHTML))),
            m.string(this.config.selectors.controls.container) && (o = document.querySelector(this.config.selectors.controls.container)),
            m.element(o) || (o = this.elements.container),
            o[m.element(n) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", n),
            ...
            if (window.navigator.userAgent.includes("Edge") && V(o),
    ...
    var he = {
        setup: function() {
            if (this.supported.ui)
                if (!this.isVideo || this.isYouTube || this.isHTML5 && !z.textTracks)
                    m.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && ce.setCaptionsMenu.call(this);
                else {
                    var e, t;
                    if (m.element(this.elements.captions) || (this.elements.captions = A("div", M(this.config.selectors.captions)),
                    e = this.elements.captions,
                    t = this.elements.wrapper,
                    m.element(e) && m.element(t) && t.parentNode.insertBefore(e, t.nextSibling)),
                    F.isIE && window.URL) {
                    ...
                    if (m.boolean(o) || (o = this.config.captions.active),
        ...
        update: function() {
            ...
            (r && this.language !== a || !t.includes(o)) && (he.setLanguage.call(this, a),
            he.toggle.call(this, i && r)),
            L(this.elements.container, this.config.classNames.captions.enabled, !m.empty(t)),
        ...
        toggle: function(e) {
            ...
            if (this.supported.ui) {
                ...
                if (a !== n) {
                    ...
                    k.call(this, this.media, a ? "captionsenabled" : "captionsdisabled")
                }
            }
        },
        set: function(e) {
        ...
        findTrack: function(e) {
            var t, n = this, i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], a = he.getTracks.call(this), s = function(e) {
        ...
        getLabel: function(e) {
            var t = e;
            return !m.track(t) && z.textTracks && this.captions.toggled && (t = he.getCurrentTrack.call(this)),
            m.track(t) ? m.empty(t.label) ? m.empty(t.language) ? te("enabled", this.config) : e.language.toUpperCase() : t.label : te("disabled", this.config)
        },
    ...
    function ke() {
        if (this.enabled) {
            ...
            k.call(this.player, this.target, this.active ? "enterfullscreen" : "exitfullscreen", !0),
            F.isIos || function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null
                  , t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                if (m.element(e)) {
    ...
    var Te = function() {
        ...
        return n(t, [{
            key: "update",
            value: function() {
                this.enabled ? this.player.debug.log("".concat(t.native ? "Native" : "Fallback", " fullscreen enabled")) : this.player.debug.log("Fullscreen not supported and fallback disabled"),
                L(this.player.elements.container, this.player.config.classNames.fullscreen.enabled, this.enabled)
            }
        }, {
            key: "enter",
            value: function() {
            ...
            key: "prefix",
            get: function() {
                if (m.function(document.exitFullscreen))
                    return "";
                var e = "";
                return ["webkit", "moz", "ms"].some(function(t) {
                    return !(!m.function(document["".concat(t, "ExitFullscreen")]) && !m.function(document["".concat(t, "CancelFullScreen")])) && (e = t,
                    !0)
                }),
                e
            }
    ...
    var Ee = {
        addStyleHook: function() {
            L(this.elements.container, this.config.selectors.container.replace(".", ""), !0),
            L(this.elements.container, this.config.classNames.uiSupported, this.supported.ui)
        },
        ...
        build: function() {
            ...
            m.element(this.elements.controls) || (ce.inject.call(this),
            ...
            L(this.elements.container, this.config.classNames.pip.supported, z.pip && this.isHTML5 && this.isVideo),
            L(this.elements.container, this.config.classNames.airplay.supported, z.airplay && this.isHTML5),
            L(this.elements.container, this.config.classNames.isIos, F.isIos),
            L(this.elements.container, this.config.classNames.isTouch, this.touch),
            this.ready = !0,
            setTimeout(function() {
                k.call(e, e.media, "ready")
            }, 0),
            Ee.setTitle.call(this),
            this.poster && Ee.setPoster.call(this, this.poster, !1).catch(function() {}),
            this.config.duration && ce.durationUpdate.call(this)
        },
        setTitle: function() {
            var e = te("play", this.config);
            if (m.string(this.config.title) && !m.empty(this.config.title) && (e += ", ".concat(this.config.title)),
        ...
        setPoster: function(e) {
            ...
            .call(this).then(function() {
                ...
                throw e === t.poster && Ee.togglePoster.call(t, !1),
                n
            }).then(function() {
                if (e !== t.poster)
        ...
        checkPlaying: function(e) {
            var t = this;
            L(this.elements.container, this.config.classNames.playing, this.playing),
            L(this.elements.container, this.config.classNames.paused, this.paused),
            L(this.elements.container, this.config.classNames.stopped, this.stopped),
        ...
        return n(t, [{
            ...
            value: function() {
                var e = this.player
                  , t = e.elements;
                e.touch = !0,
                L(t.container, e.config.classNames.isTouch, !0)
            }
        }, {
            key: "setTabFocus",
            value: function(e) {
            ...
            value: function() {
                var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0]
                  , t = this.player;
                t.config.keyboard.global && g.call(t, window, "keydown keyup", this.handleKey, e, !1),
                g.call(t, document.body, "click", this.toggleMenu, e),
                b.call(t, document.body, "touchstart", this.firstTouch),
                g.call(t, document.body, "keydown focus blur", this.setTabFocus, e, !1, !0)
            }
        }, {
            key: "container",
            value: function() {
                var e = this.player
                  , t = e.elements;
                !e.config.keyboard.global && e.config.keyboard.focused && y.call(e, t.container, "keydown keyup", this.handleKey, !1),
                y.call(e, t.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", function(n) {
                    var i = t.controls;
                    i && "enterfullscreen" === n.type && (i.pressed = !1,
                    i.hover = !1);
                    var a = 0;
                    ["touchstart", "touchmove", "mousemove"].includes(n.type) && (Ee.toggleControls.call(e, !0),
                    a = e.touch ? 3e3 : 2e3),
            ...
            value: function() {
                ...
                y.call(e, e.media, "canplay", function() {
                    N(t.volume, !e.hasAudio),
                    N(t.buttons.mute, !e.hasAudio)
                }),
                ...
                e.supported.ui && e.config.clickToPlay && !e.isAudio) {
                    ...
                    y.call(e, t.container, "click", function(i) {
                        ([t.container, n].includes(i.target) || n.contains(i.target)) && (e.touch && e.config.hideControls || (e.ended ? (e.restart(),
                        e.play()) : e.togglePlay()))
                    })
                }
            ...
            value: function() {
                ...
                this.bind(n.buttons.settings, "keyup", function(e) {
                    ...
                    e.stopPropagation(),
                    ce.toggleMenu.call(t, e)) : ce.focusFirstMenuItem.call(t, null, !0))
                }, null, !1),
    ...
    var Ce, Se = (function(e, t) {
        ...
        n = function() {
            ...
            function o(t, n, i, a) {
                ...
                r.href = h) : /(^img!|\.(png|gif|jpg|svg)$)/.test(t) ? (r = l.createElement("img")).src = h : ((r = l.createElement("script")).src = t,
                r.async = void 0 === c || c),
    ...
    var Le = {
        setup: function() {
            ...
            m.object(window.Vimeo) ? Le.ready.call(this) : Me(this.config.urls.vimeo.sdk).then(function() {
                Le.ready.call(e)
            }).catch(function(t) {
        ...
        ready: function() {
            ...
            var a, s = (a = i,
            m.empty(a) ? null : m.number(Number(a)) ? a : a.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : a), o = A("iframe"), r = Q(t.config.urls.vimeo.iframe, s, n);
            ...
            t.embed.on("progress", function(e) {
                ...
                1 === parseInt(e.percent, 10) && k.call(t, t.media, "canplaythrough"),
                t.embed.getDuration().then(function(e) {
            ...
            t.embed.on("seeked", function() {
                t.media.seeking = !1,
                k.call(t, t.media, "seeked")
            }),
            t.embed.on("ended", function() {
                t.media.paused = !0,
                k.call(t, t.media, "ended")
            }),
            t.embed.on("error", function(e) {
                t.media.error = e,
                k.call(t, t.media, "error")
            }),
            setTimeout(function() {
    ...
    var Ie, _e = {
        setup: function() {
            ...
            m.object(window.YT) && m.function(window.YT.Player) ? _e.ready.call(this) : (Me(this.config.urls.youtube.sdk).catch(function(t) {
        ...
        ready: function() {
            ...
            if (m.empty(t) || !t.startsWith("youtube-")) {
                ...
                var i, a, s = (i = n,
                m.empty(i) ? null : i.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : i), o = (a = e.provider,
                "".concat(a, "-").concat(Math.floor(1e4 * Math.random()))), r = A("div", {
                    id: o,
                    poster: e.poster
                });
                e.media = S(r, e.media);
                    ...
                    events: {
                        ...
                        onReady: function(t) {
                            if (!m.function(e.media.play)) {
                                ...
                                e.timers.buffering = setInterval(function() {
                                    ...
                                    (null === e.media.lastBuffered || e.media.lastBuffered < e.media.buffered) && k.call(e, e.media, "progress"),
                        ...
                        onStateChange: function(t) {
                            ...
                            case 0:
                                ...
                                n.playVideo()) : k.call(e, e.media, "ended");
                                break;
                            case 1:
                                e.media.paused && !e.embed.hasPlayed ? e.media.pause() : (xe.call(e, !0),
        ...
        setup: function() {
            this.media ? (L(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
            L(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0),
            this.isEmbed && L(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0),
            this.isVideo && (this.elements.wrapper = A("div", {
            ...
            this.isHTML5 ? W.extend.call(this) : this.isYouTube ? _e.setup.call(this) : this.isVimeo && Le.setup.call(this)) : this.debug.warn("No media element found!")
        }
    }, Oe = function() {
        function t(n) {
            var i = this;
        ...
        return n(t, [{
            ...
            value: function(e) {
                ...
                if (this.enabled) {
                    ...
                    m.empty(this.cuePoints) || this.cuePoints.forEach(function(e) {
            ...
            key: "on",
            value: function(e, t) {
                return m.array(this.events[e]) || (this.events[e] = []),
            ...
            value: function(e) {
                m.nullOrUndefined(this.safetyTimer) || (this.player.debug.log("Safety timer cleared from: ".concat(e)),
        ...
        change: function(e) {
            var t = this;
            Y(e, "sources.length") ? (W.cancelRequests.call(this),
            this.destroy.call(this, function() {
                t.options.quality = [],
                P(t.media),
                t.media = null,
                m.element(t.elements.container) && t.elements.container.removeAttribute("class");
                var n = e.sources
                  , i = e.type
                  , s = a(n, 1)[0]
                  , o = s.provider
                ...
                je.setup.call(t),
                t.isHTML5 && ("tracks"in e && qe.insertElements.call(t, "track", e.tracks),
                t.media.load()),
                (t.isHTML5 || t.isEmbed && !t.supported.ui) && Ee.build.call(t),
                t.fullscreen.update()
        ...
        function t(n, i) {
            ...
            this.touch = z.touch,
            this.media = n,
            m.string(this.media) && (this.media = document.querySelectorAll(this.media)),
            (window.jQuery && this.media instanceof jQuery || m.nodeList(this.media) || m.array(this.media)) && (this.media = this.media[0]),
            this.config = J({}, pe, t.defaults, i || {}, function() {
                try {
            ...
            !m.nullOrUndefined(this.media) && m.element(this.media))
                if (this.media.plyr)
                    ...
                    if (z.check().api) {
                        ...
                        case "div":
                            ...
                            m.element(r)) {
                                ...
                                l.search.length) {
                                    ...
                                    this.config.hl = l.searchParams.get("hl")) : this.config.playsinline = !0
                                }
                            } else
                                this.provider = this.media.getAttribute(this.config.attributes.embed.provider),
                                this.media.removeAttribute(this.config.attributes.embed.provider);
                            if (m.empty(this.provider) || !Object.keys(ge).includes(this.provider))
                        ...
                        m.element(this.elements.container) || (this.elements.container = A("div"),
                        w(this.media, this.elements.container)),
                        Ee.addStyleHook.call(this),
                        je.setup.call(this),
                        this.config.debug && y.call(this, this.elements.container, this.config.events.join(" "), function(e) {
                            a.debug.log("event: ".concat(e.type))
                        }),
                        (this.isHTML5 || this.isEmbed && !this.supported.ui) && Ee.build.call(this),
        ...
        return n(t, [{
            ...
            value: function() {
                ...
                this.restart()) : m.function(this.media.stop) && this.media.stop()
            }
        }, {
            key: "restart",
            value: function() {
            ...
            value: function(e) {
                if (this.supported.ui && !this.isAudio) {
                    ...
                    if (i && this.config.controls.includes("settings") && !m.empty(this.config.settings) && ce.toggleMenu.call(this, !1),
                    i !== t) {
            ...
            value: function(e) {
                ...
                if (this.ready) {
                    var i = function() {
                        ...
                        t.embed = null,
                        n ? (Object.keys(t.elements).length && (P(t.elements.buttons.play),
                    ...
                    null !== this.embed && m.function(this.embed.destroy) && this.embed.destroy(),
            ...
            set: function(e) {
                if (z.pip) {
                    ...
                    m.function(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? me : fe),
                    m.function(this.media.requestPictureInPicture) && (!this.pip && t ? this.media.requestPictureInPicture() : this.pip && !t && document.exitPictureInPicture())
                }
            },
            get: function() {
            ...
            value: function(e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                  , i = null;
                return m.string(e) ? i = Array.from(document.querySelectorAll(e)) : m.nodeList(e) ? i = Array.from(e) : m.array(e) && (i = e.filter(m.element)),
                m.empty(i) ? null : i.map(function(e) {
                    return new t(e,n)
                })
            }
        }]),
